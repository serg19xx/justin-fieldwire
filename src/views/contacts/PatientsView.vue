            ...
            <div class="flex-1">
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                  <span
                    class="bg-purple-100 text-purple-800 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                  >
                    Patient
                  </span>
                  <span
              ...
              <p class="mt-1 text-sm text-gray-500">{{ patient.organization }}</p>
