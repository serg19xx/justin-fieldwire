...
const tasks = ref([
  ...
  },
  {
    ...
    project: 'Guelph Care XPS',
    assignee: 'John Viewer',
    priority: 'low',
    dueDate: '2024-01-15',
    status: 'completed',
  },
...
<template>
  <div class="space-y-6 p-6">
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-gray-500">Complete overview of all project tasks</p>
    </div>
    ...
    <div class="bg-white shadow rounded-lg">
      <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-medium text-gray-900">All Tasks ({{ tasks.length }})</h3>
      </div>
