...
import { type ProjectPriority, type ProjectStatus } from '@/core/utils/constants'
...
async function createNewProject() {
  ...
  try {
    ...
    const apiProject = await projectApi.create(projectData)
...
async function deleteProject(projectId: number) {
  if (
    !confirm('Are you sure you want to delete this draft project? This action cannot be undone.')
  ) {
    return
  }
...
async function archiveProject(projectId: number) {
  if (
    !confirm(
      'Are you sure you want to archive this closed project? It will be hidden from reports.',
    )
  ) {
    return
  }
  ...
  try {
    // Update project status to archived (not physically deleted)
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <span class="text-sm text-gray-500"
                    >{{
                      getProgressPercentage(project.startDate, project.endDate, project.status)
                    }}%</span
                  >
                </div>
              </td>
      ...
      <div class="lg:hidden">
        <div class="divide-y divide-gray-200">
          <div v-for="project in filteredProjects" :key="project.id" class="p-4 hover:bg-gray-50">
            <div class="flex items-start justify-between mb-2">
              <div class="flex-1 cursor-pointer" @click="openProject(project.id)">
          ...
          <form @submit.prevent="createNewProject" class="px-6 py-4 space-y-4">
            ...
            <div class="flex justify-end space-x-3 pt-4">
              ...
              <button
                type="submit"
                :disabled="
                  isSubmitting || !newProjectForm.name.trim() || !newProjectForm.address.trim()
                "
