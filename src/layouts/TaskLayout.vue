<template>
  <div class="min-h-screen bg-gray-100 flex flex-col safe-area-pb">
    ...
    <nav
      class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex items-center justify-around h-16 safe-area-pb z-40"
      role="navigation"
      aria-label="Main"
    >
      <RouterLink
        to="/dashboard"
        class="flex flex-col items-center justify-center flex-1 h-full text-orange-600 min-w-0"
        :class="$route.path === '/dashboard' ? 'bg-orange-50 font-medium' : 'text-gray-500 hover:bg-gray-50'"
      >
        ...
        <span class="text-xs mt-0.5 truncate w-full text-center px-0.5">Dashboard</span>
      </RouterLink>
      <RouterLink
        to="/tasks"
        class="flex flex-col items-center justify-center flex-1 h-full min-w-0"
        :class="$route.path.startsWith('/tasks') || $route.path.startsWith('/projects') ? 'text-orange-600 bg-orange-50 font-medium' : 'text-gray-500 hover:bg-gray-50'"
      >
        <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
        </svg>
        <span class="text-xs mt-0.5 truncate w-full text-center px-0.5">Projects</span>
      </RouterLink>
      <RouterLink
        to="/reports"
        class="flex flex-col items-center justify-center flex-1 h-full min-w-0"
      ...
      >
        ...
        <span class="text-xs mt-0.5 truncate w-full text-center px-0.5">Account</span>
      </RouterLink>
    </nav>
  </div>
</template>
